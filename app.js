...
function updateWordCount(){
    ...
    document.getElementById('charCount').innerHTML = `Goal: ${TARGET_WORDS} <span style="font-size:0.9rem; color:#555;">(${words} words written)</span>`;
...
function analyzeWords(){
    ...
    document.getElementById('wordCount').innerHTML=html;
}
